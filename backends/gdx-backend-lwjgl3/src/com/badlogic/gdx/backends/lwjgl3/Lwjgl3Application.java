...
public class Lwjgl3Application implements Application {
  ...
  public final ObjectMap<String,Preferences> preferences=new ObjectMap<String,Preferences>();
  public final Lwjgl3Clipboard clipboard;
  public int logLevel=LOG_INFO;
  public volatile boolean running=true;
  public final Array<Runnable> runnables=new Array<Runnable>();
  public final Array<Runnable> executedRunnables=new Array<Runnable>();
  public final Array<LifecycleListener> lifecycleListeners=new Array<LifecycleListener>();
 ...
 */
  ...
  public Lwjgl3Window createWindow(  Lwjgl3ApplicationConfiguration config,  ApplicationListener listener,  long sharedContext){
  ...
  public static boolean supportsFBO(){
    return glVersion.isVersionEqualToOrHigher(3,0) || GLFW.glfwExtensionSupported("GL_EXT_framebuffer_object") == GLFW.GLFW_TRUE || GLFW.glfwExtensionSupported("GL_ARB_framebuffer_object") == GLFW.GLFW_TRUE;
  }
  ...
  public void setglVersion(  GLVersion glVersion){
