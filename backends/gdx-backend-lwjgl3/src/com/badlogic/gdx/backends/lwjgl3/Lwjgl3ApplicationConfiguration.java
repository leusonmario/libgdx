 ...
 */
  ...
  /** 
 * Whether to disable audio or not. If set to false, the returned audio class instances like  {@link Audio} or {@link Music} will be mockimplementations.
 */
 ...
 */
  ...
  /** 
 * Sets whether to use OpenGL ES 3.0 emulation. If the given major/minor version is not supported, the backend falls back to OpenGL ES 2.0 emulation. The default parameters for major and minor should be 3 and 2 respectively to be compatible with Mac OS X. Specifying major version 4 and minor version 2 will ensure that all OpenGL ES 3.0 features are supported. Note however that Mac OS X does only support 3.2.
 * @see <a href=
 ...
 */
  ...
  /** 
 * Sets the position of the window in windowed mode on the primary monitor. Default -1 for booth coordinates for centered.
 */
  ...
  /** 
 * Sets the  {@link Lwjgl3WindowListener} which will be informed abouticonficiation, focus loss and window close events.
 */
  public void setWindowListener(  Lwjgl3WindowListener windowListener){
    this.windowListener=windowListener;
  }
  /** 
 * Sets the app to use fullscreen mode. Use the static methods like {@link #getDisplayMode()} on this class to enumerate connected monitorsand their fullscreen display modes.
 */
 ...
 */
  ...
  /** 
 * Sets the directory where  {@link Preferences} will be stored, as well asthe file type to be used to store them. Defaults to "$USER_HOME/.prefs/" and  {@link FileType#External}.
 */
 ...
 * mouse coordinates,  {@link Graphics#getWidth()} and{@link Graphics#getHeight()} will return logical coordinatesaccording to the system defined HDPI scaling. Rendering will be performed to a backbuffer at raw resolution. Use  {@link HdpiUtils}when calling  {@link GL20#glScissor} or {@link GL20#glViewport} whichexpect raw coordinates.
 */
  Logical,   /** 
 * Mouse coordinates,  {@link Graphics#getWidth()} and{@link Graphics#getHeight()} will return raw pixel coordinatesirrespective of the system defined HDPI scaling.
 */
  Pixels}
  ...
  public int getgles30ContextMajorVersion(){
    return this.gles30ContextMajorVersion;
  }
  public int getgles30ContextMinorVersion(){
    return this.gles30ContextMinorVersion;
  }
  public int getdepth(){
    return this.depth;
  }
  ...
  public boolean getwindowDecorated(){
  ...
  public Files.FileType getpreferencesFileType(){
    return this.preferencesFileType;
  }
  ...
  public void setgles30ContextMajorVersion(  int gles30ContextMajorVersion){
    this.gles30ContextMajorVersion=gles30ContextMajorVersion;
  }
  public void setgles30ContextMinorVersion(  int gles30ContextMinorVersion){
